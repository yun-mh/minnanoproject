...
$sel_query = "SELECT post_author FROM posts_notice WHERE post_id = {$the_post_id} ";
...
$select_query = "SELECT * FROM posts_notice WHERE post_id = $the_post_id ";
...
if(isset($_POST['update_post'])) {
  ...
  $update_post_image_temp = $_FILES['image']['tmp_name'];
	...
	if(empty($error)) {
		...
		$update_query = "UPDATE posts_notice SET ";
		...
		if($update_post_image != NULL) {
			$up_img_query = "UPDATE posts_notice SET ";
